...
public class taskController implements Initializable {
    ...
    @FXML private void addNewTask(){
        ...
        if(taskName.getText().isEmpty()||taskName.getText()==(warningMessage))
            ...
            Task newTask = new Task(taskName.getText(),new Tooltip(descriptionArea.getText().toString()),priorityChoiceBox.getValue(),LocalDate.now());

            mainController.destination.getItems().add(newTask);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        priorityChoiceBox.getItems().clear();
